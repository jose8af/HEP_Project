...
C     
C     Process: u u~ > e+ e- WEIGHTED<=4 @1
C     Process: u u~ > mu+ mu- WEIGHTED<=4 @1
C     Process: c c~ > e+ e- WEIGHTED<=4 @1
C     Process: c c~ > mu+ mu- WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,5))  !  count 4
      CALL IXXXXX(P(0,3),ZERO,-1,-1*IC(3),W(1,6))  !  count 4
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7))  !  count 4
      CALL OXXXXX(P(0,4),ZERO,-1,+1*IC(4),W(1,8))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_0(W(1,5),W(1,8),W(1,9),GC_3,AMP(1,1))
      CALL FFV1_0(W(1,5),W(1,8),W(1,10),GC_3,AMP(3,1))
      CALL FFV1_0(W(1,6),W(1,7),W(1,9),GC_3,AMP(2,1))
      CALL FFV1_0(W(1,6),W(1,7),W(1,10),GC_3,AMP(4,1))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,11))
     $  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,3),-GC_50,GC_58,MDL_MZ,FK_MDL_WZ,W(1,12))
     $  !  count 2
      CALL FFV2_4_0(W(1,5),W(1,8),W(1,11),GC_50,GC_59,AMP(1,2))
      CALL FFV2_4_0(W(1,5),W(1,8),W(1,12),GC_50,GC_59,AMP(3,2))
      CALL FFV2_4_0(W(1,6),W(1,7),W(1,11),GC_50,GC_59,AMP(2,2))
      CALL FFV2_4_0(W(1,6),W(1,7),W(1,12),GC_50,GC_59,AMP(4,2))  !  count 1
