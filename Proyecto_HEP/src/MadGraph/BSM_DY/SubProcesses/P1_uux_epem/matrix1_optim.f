...
C     
C     Process: u u~ > e+ e- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MU,+1,+1*IC(1),W(1,1))  !  count 3
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 3
      CALL OXXXXX(P(0,2),MDL_MU,+1,-1*IC(2),W(1,3))  !  count 3
      CALL OXXXXX(P(0,2),MDL_MU,-1,-1*IC(2),W(1,4))  !  count 3
      CALL IXXXXX(P(0,3),MDL_ME,+1,-1*IC(3),W(1,5))  !  count 6
      CALL IXXXXX(P(0,3),MDL_ME,-1,-1*IC(3),W(1,6))  !  count 6
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,7))  !  count 6
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,8))  !  count 6
      CALL FFV1P0_3(W(1,1),W(1,4),GC_3,ZERO,FK_ZERO,W(1,13))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_0(W(1,5),W(1,8),W(1,13),GC_4,AMP(1,3))
      CALL FFV1_0(W(1,5),W(1,8),W(1,14),GC_4,AMP(3,3))
      CALL FFV1_0(W(1,6),W(1,7),W(1,13),GC_4,AMP(2,3))
      CALL FFV1_0(W(1,6),W(1,7),W(1,14),GC_4,AMP(4,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,3),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 2
      CALL FFV2_4_0(W(1,5),W(1,8),W(1,15),GC_34,GC_43,AMP(1,4))
      CALL FFV2_4_0(W(1,5),W(1,8),W(1,16),GC_34,GC_43,AMP(3,4))
      CALL FFV2_4_0(W(1,6),W(1,7),W(1,15),GC_34,GC_43,AMP(2,4))
      CALL FFV2_4_0(W(1,6),W(1,7),W(1,16),GC_34,GC_43,AMP(4,4))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_36,GC_45,MDL_MZP,FK_MDL_WZP,W(1,17)
     $)  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,3),GC_36,GC_45,MDL_MZP,FK_MDL_WZP,W(1,18)
     $)  !  count 2
      CALL FFV2_4_0(W(1,5),W(1,8),W(1,17),GC_37,GC_46,AMP(1,5))
      CALL FFV2_4_0(W(1,5),W(1,8),W(1,18),GC_37,GC_46,AMP(3,5))
      CALL FFV2_4_0(W(1,6),W(1,7),W(1,17),GC_37,GC_46,AMP(2,5))
      CALL FFV2_4_0(W(1,6),W(1,7),W(1,18),GC_37,GC_46,AMP(4,5))  !  count 1
