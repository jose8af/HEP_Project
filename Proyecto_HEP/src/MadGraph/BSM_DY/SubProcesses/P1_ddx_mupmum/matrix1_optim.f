...
C     
C     Process: d d~ > mu+ mu- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      ...
      CALL IXXXXX(P(0,1),MDL_MD,-1,+1*IC(1),W(1,2))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MD,+1,-1*IC(2),W(1,3))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MD,-1,-1*IC(2),W(1,4))  !  count 7
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,5))  !  count 20
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,6))  !  count 12
      CALL OXXXXX(P(0,4),MDL_MM,+1,+1*IC(4),W(1,7))  !  count 12
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,8))  !  count 20
      CALL FFS1_3(W(1,1),W(1,3),GC_73,MDL_MH,FK_MDL_WH,W(1,9))  !  count 1
      CALL FFS1_3(W(1,2),W(1,4),GC_73,MDL_MH,FK_MDL_WH,W(1,12))  !  count 1
      CALL FFS1P1N_3(W(1,5), W(1,8), GC_77, TMP(1))
      call CombineAmpS(2, 
     &(/5,6/), 
     & (/9,12/), 
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_2,ZERO,FK_ZERO,W(1,20))  !  count 1
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_3(W(1,1),W(1,3),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,21))  !  count 1
      ...
      CALL FFV2_3_3(W(1,2),W(1,4),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,24))  !  count 1
