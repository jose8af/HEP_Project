...
C     ----------
     ...
     $    ABS(MDL_MZP*SMALL_WIDTH_TREATMENT)), MDL_WZP)
      ...
      CALL OXXXXX(P(0,4),MDL_MM,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS1_3(W(1,1),W(1,2),GC_71,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,3),W(1,4),W(1,5),GC_77,AMP(1))
      CALL FFS1_3(W(1,1),W(1,2),GC_72,MDL_MHS, FK_MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,3),W(1,4),W(1,5),GC_78,AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_3,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_4,AMP(3))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_35,GC_42,MDL_MZ, FK_MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,3),W(1,4),W(1,5),GC_34,GC_43,AMP(4))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_36,GC_45,MDL_MZP, FK_MDL_WZP,W(1
     $ ,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_4_0(W(1,3),W(1,4),W(1,5),GC_37,GC_46,AMP(5))
