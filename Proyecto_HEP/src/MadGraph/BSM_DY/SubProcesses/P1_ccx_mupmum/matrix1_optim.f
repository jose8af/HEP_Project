...
C     
C     Process: c c~ > mu+ mu- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MC,+1,+1*IC(1),W(1,1))  !  count 7
      CALL IXXXXX(P(0,1),MDL_MC,-1,+1*IC(1),W(1,2))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MC,+1,-1*IC(2),W(1,3))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MC,-1,-1*IC(2),W(1,4))  !  count 7
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,5))  !  count 28
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,6))  !  count 28
      CALL OXXXXX(P(0,4),MDL_MM,+1,+1*IC(4),W(1,7))  !  count 28
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,8))  !  count 28
      CALL FFS1_3(W(1,1),W(1,3),GC_71,MDL_MH,FK_MDL_WH,W(1,9))  !  count 4
      CALL FFS1_3(W(1,2),W(1,4),GC_71,MDL_MH,FK_MDL_WH,W(1,12))  !  count 4
      CALL FFS1P1N_1(W(1,7), W(1,9), GC_77, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL FFS1P1N_1(W(1,7), W(1,12), GC_77, TMP(1))
      call CombineAmp(2,
     & (/10,12/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL FFS1P1N_1(W(1,8), W(1,9), GC_77, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))
      CALL FFS1P1N_1(W(1,8), W(1,12), GC_77, TMP(1))
      call CombineAmp(2,
     & (/9,11/), 
     & (/5,6/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,3),GC_3,ZERO,FK_ZERO,W(1,17))  !  count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_3,ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_3,ZERO,FK_ZERO,W(1,20))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,21))  !  count 4
      CALL FFV2_5_3(W(1,1),W(1,4),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,22))  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,23))  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,4),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,24))  !  count 4
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_36,GC_45,MDL_MZP,FK_MDL_WZP,W(1,25)
     $)  !  count 4
      CALL FFV2_5_3(W(1,1),W(1,4),GC_36,GC_45,MDL_MZP,FK_MDL_WZP,W(1,26)
     $)  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_36,GC_45,MDL_MZP,FK_MDL_WZP,W(1,27)
     $)  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,4),GC_36,GC_45,MDL_MZP,FK_MDL_WZP,W(1,28)
     $)  !  count 4
