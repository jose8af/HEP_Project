...
GC_34 = Coupling(name = 'GC_34',
                 value = '-0.5*(ca*cw*ee*complex(0,1))/sw',
                 order = {'QED':1})
...
GC_36 = Coupling(name = 'GC_36',
                 value = '-0.5*(cw*ee*complex(0,1)*sa)/sw',
                 order = {'QED':1})
...
GC_42 = Coupling(name = 'GC_42',
                 value = '(ee*eta*complex(0,1)*sa)/(6.*cw) + (ca*cw*ee*complex(0,1))/(2.*sw) - (ca*ee*complex(0,1)*sw)/(6.*cw)',
                 order = {'QED':1})

GC_43 = Coupling(name = 'GC_43',
                 value = '-0.5*(ee*eta*complex(0,1)*sa)/cw - (ca*cw*ee*complex(0,1))/(2.*sw) + (ca*ee*complex(0,1)*sw)/(2.*cw)',
                 order = {'QED':1})
...
GC_45 = Coupling(name = 'GC_45',
                 value = '(2*ee*eta*complex(0,1)*sa)/(3.*cw) - (2*ca*ee*complex(0,1)*sw)/(3.*cw)',
                 order = {'QED':1})

GC_46 = Coupling(name = 'GC_46',
                 value = '-((ee*eta*complex(0,1)*sa)/cw) + (ca*ee*complex(0,1)*sw)/cw',
                 order = {'QED':1})
...
GC_48 = Coupling(name = 'GC_48',
                 value = '(ca*ee*eta*complex(0,1))/(6.*cw) + (cw*ee*complex(0,1)*sa)/(2.*sw) + (ee*complex(0,1)*sa*sw)/(6.*cw)',
                 order = {'QED':1})

GC_49 = Coupling(name = 'GC_49',
                 value = '-0.3333333333333333*(ca*ee*eta*complex(0,1))/cw - (ee*complex(0,1)*sa*sw)/(3.*cw)',
                 order = {'QED':1})

GC_50 = Coupling(name = 'GC_50',
                 value = '-0.5*(ca*ee*eta*complex(0,1))/cw - (cw*ee*complex(0,1)*sa)/(2.*sw) - (ee*complex(0,1)*sa*sw)/(2.*cw)',
                 order = {'QED':1})
...
GC_52 = Coupling(name = 'GC_52',
                 value = '-((ca*ee*eta*complex(0,1))/cw) - (ee*complex(0,1)*sa*sw)/cw',
                 order = {'QED':1})
