...
C     
C     Process: s s~ > e+ e- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      ...
      CALL IXXXXX(P(0,3),MDL_ME,+1,-1*IC(3),W(1,5))  !  count 14
      CALL IXXXXX(P(0,3),MDL_ME,-1,-1*IC(3),W(1,6))  !  count 14
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,7))  !  count 14
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,8))  !  count 14
      ...
      CALL FFS1_0(W(1,5),W(1,8),W(1,9),GC_75,AMP(3,1))
      CALL FFS1_0(W(1,5),W(1,8),W(1,12),GC_75,AMP(5,1))
      CALL FFS1_0(W(1,6),W(1,7),W(1,9),GC_75,AMP(4,1))
      CALL FFS1_0(W(1,6),W(1,7),W(1,12),GC_75,AMP(6,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,19))  !  count 2
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      CALL FFV2_3_3(W(1,1),W(1,4),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,22))  !  count 2
      CALL FFV2_3_3(W(1,2),W(1,3),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,23))  !  count 2
