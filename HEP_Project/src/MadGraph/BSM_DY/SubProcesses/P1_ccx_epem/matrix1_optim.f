...
C     
C     Process: c c~ > e+ e- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      ...
      CALL FFS1_3(W(1,1),W(1,3),GC_71,MDL_MH,FK_MDL_WH,W(1,9))  !  count 2
      CALL FFS1_3(W(1,2),W(1,4),GC_71,MDL_MH,FK_MDL_WH,W(1,12))  !  count 2
      ...
      CALL FFV1P0_3(W(1,1),W(1,3),GC_3,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,4),GC_3,ZERO,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO,FK_ZERO,W(1,19))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,4),GC_3,ZERO,FK_ZERO,W(1,20))  !  count 2
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,21))  !  count 2
      CALL FFV2_5_3(W(1,1),W(1,4),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,22))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,3),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,23))  !  count 2
      CALL FFV2_5_3(W(1,2),W(1,4),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,24))  !  count 2
