...
C     
C     Process: g g > mu+ mu- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,5))  !  count 2
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,6))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MM,+1,+1*IC(4),W(1,7))  !  count 2
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,8))  !  count 2
      CALL VVS2_3(W(1,1),W(1,3),GC_8,MDL_MH,FK_MDL_WH,W(1,9))  !  count 2
      CALL VVS2_3(W(1,2),W(1,4),GC_8,MDL_MH,FK_MDL_WH,W(1,10))  !  count 2
      CALL FFS1_0(W(1,5),W(1,7),W(1,9),GC_77,AMP(3,1))
      CALL FFS1_0(W(1,5),W(1,7),W(1,10),GC_77,AMP(1,1))
      CALL FFS1_0(W(1,6),W(1,8),W(1,9),GC_77,AMP(4,1))
      CALL FFS1_0(W(1,6),W(1,8),W(1,10),GC_77,AMP(2,1))  !  count 1
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = (2.000000000000000D+00)*AMP( K,1)+(2.000000000000000
     $  D +00)*AMP( K,2)
