...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL VVS2_3(W(1,1),W(1,2),GC_8,MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,3),W(1,4),W(1,5),GC_77,AMP(1))
      CALL VVS2_3(W(1,1),W(1,2),GC_18,MDL_MHS, FK_MDL_WHS,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,3),W(1,4),W(1,5),GC_78,AMP(2))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (2.000000000000000D+00)*AMP(1)+(2.000000000000000D
     $ +00)*AMP(2)
