...
C     
C     Process: s s~ > mu+ mu- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Needed for v4 models
      ...
      double precision fk_mdl_WZp 
      double precision fk_mdl_WZ 
      double precision fk_mdl_WHS 
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WH)
        IF(mdl_WHS.ne.0d0) fk_mdl_WHS = SIGN(MAX(ABS(mdl_WHS),
     $    ABS(mdl_MHS*small_width_treatment)), mdl_WHS)
     ...
     $   *small_width_treatment)), mdl_WZ)
        IF(mdl_WZp.ne.0d0) fk_mdl_WZp = SIGN(MAX(ABS(mdl_WZp),
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      endif
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MS,+1,+1*IC(1),W(1,1))  !  count 7
      CALL IXXXXX(P(0,1),MDL_MS,-1,+1*IC(1),W(1,2))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MS,+1,-1*IC(2),W(1,3))  !  count 7
      CALL OXXXXX(P(0,2),MDL_MS,-1,-1*IC(2),W(1,4))  !  count 7
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,5))  !  count 20
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,6))  !  count 20
      CALL OXXXXX(P(0,4),MDL_MM,+1,+1*IC(4),W(1,7))  !  count 20
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,8))  !  count 20
      CALL FFS1_3(W(1,1),W(1,3),GC_79,MDL_MH,FK_MDL_WH,W(1,9))  !  count 2
      CALL FFS1_3(W(1,2),W(1,4),GC_79,MDL_MH,FK_MDL_WH,W(1,12))  !  count 2
      CALL FFS1_0(W(1,5),W(1,8),W(1,9),GC_77,AMP(5,1))
      CALL FFS1_0(W(1,5),W(1,8),W(1,12),GC_77,AMP(7,1))
      CALL FFS1_0(W(1,6),W(1,7),W(1,9),GC_77,AMP(6,1))
      CALL FFS1_0(W(1,6),W(1,7),W(1,12),GC_77,AMP(8,1))  !  count 1
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO,FK_ZERO,W(1,18))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,FK_ZERO,W(1,19))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,4),GC_2,ZERO,FK_ZERO,W(1,20))  !  count 2
      CALL FFV1P1N_3(W(1,5), W(1,7), GC_4, TMP(1))
      call CombineAmp(2,
     & (/2,10/), 
     & (/18,19/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_3(W(1,5), W(1,8), GC_4, TMP(1))
      call CombineAmp(4,
     & (/5,1,9,7/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_3(W(1,6), W(1,7), GC_4, TMP(1))
      call CombineAmp(4,
     & (/6,4,12,8/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_3(W(1,6), W(1,8), GC_4, TMP(1))
      call CombineAmp(2,
     & (/3,11/), 
     & (/18,19/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_3_3(W(1,1),W(1,3),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,21))  !  count 2
      CALL FFV2_3_3(W(1,1),W(1,4),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,22))  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,3),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,23))  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,4),GC_34,GC_42,MDL_MZ,FK_MDL_WZ,W(1,24))  !  count 2
      CALL FFV2_4P1N_3(W(1,5), W(1,7), GC_34, GC_43, TMP(1))
      call CombineAmp(2,
     & (/2,10/), 
     & (/22,23/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4P1N_3(W(1,5), W(1,8), GC_34, GC_43, TMP(1))
      call CombineAmp(4,
     & (/5,1,9,7/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4P1N_3(W(1,6), W(1,7), GC_34, GC_43, TMP(1))
      call CombineAmp(4,
     & (/6,4,12,8/), 
     & (/21,22,23,24/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4P1N_3(W(1,6), W(1,8), GC_34, GC_43, TMP(1))
      call CombineAmp(2,
     & (/3,11/), 
     & (/22,23/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFV2_3_3(W(1,1),W(1,3),GC_37,GC_45,MDL_MZP,FK_MDL_WZP,W(1,25)
     $)  !  count 2
      CALL FFV2_3_3(W(1,1),W(1,4),GC_37,GC_45,MDL_MZP,FK_MDL_WZP,W(1,26)
     $)  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,3),GC_37,GC_45,MDL_MZP,FK_MDL_WZP,W(1,27)
     $)  !  count 4
      CALL FFV2_3_3(W(1,2),W(1,4),GC_37,GC_45,MDL_MZP,FK_MDL_WZP,W(1,28)
     $)  !  count 2
      CALL FFV2_4P1N_3(W(1,5), W(1,7), GC_37, GC_46, TMP(1))
      call CombineAmp(2,
     & (/2,10/), 
     & (/26,27/),
     & TMP, W, AMP(1,5))
      CALL FFV2_4P1N_3(W(1,5), W(1,8), GC_37, GC_46, TMP(1))
      call CombineAmp(4,
     & (/5,1,9,7/), 
     & (/25,26,27,28/),
     & TMP, W, AMP(1,5))
      CALL FFV2_4P1N_3(W(1,6), W(1,7), GC_37, GC_46, TMP(1))
      call CombineAmp(4,
     & (/6,4,12,8/), 
     & (/25,26,27,28/),
     & TMP, W, AMP(1,5))
      CALL FFV2_4P1N_3(W(1,6), W(1,8), GC_37, GC_46, TMP(1))
      call CombineAmp(2,
     & (/3,11/), 
     & (/26,27/),
