...
C     
C     Process: u u~ > mu+ mu- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MZp*small_width_treatment)), mdl_WZp)
      ...
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,8))  !  count 12
      CALL FFV1P0_3(W(1,1),W(1,4),GC_3,ZERO,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_3,ZERO,FK_ZERO,W(1,14))  !  count 4
      CALL FFV1P1N_1(W(1,7), W(1,13), GC_4, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/5,6/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,7), W(1,14), GC_4, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/5,6/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,8), W(1,13), GC_4, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/5,6/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,8), W(1,14), GC_4, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/5,6/),
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,15))  !  count 4
      CALL FFV2_5_3(W(1,2),W(1,3),GC_35,GC_42,MDL_MZ,FK_MDL_WZ,W(1,16))  !  count 4
      CALL FFV2_4P1N_1(W(1,7), W(1,15), GC_34, GC_43, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/5,6/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4P1N_1(W(1,7), W(1,16), GC_34, GC_43, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/5,6/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4P1N_1(W(1,8), W(1,15), GC_34, GC_43, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/5,6/),
     & TMP, W, AMP(1,4))
      CALL FFV2_4P1N_1(W(1,8), W(1,16), GC_34, GC_43, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/5,6/),
     ...
     $)  !  count 4
      CALL FFV2_4P1N_1(W(1,7), W(1,17), GC_37, GC_46, TMP(1))
      call CombineAmp(2,
     & (/2,4/), 
     & (/5,6/),
     & TMP, W, AMP(1,5))
      CALL FFV2_4P1N_1(W(1,7), W(1,18), GC_37, GC_46, TMP(1))
      call CombineAmp(2,
     & (/6,8/), 
     & (/5,6/),
     & TMP, W, AMP(1,5))
      CALL FFV2_4P1N_1(W(1,8), W(1,17), GC_37, GC_46, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/5,6/),
     & TMP, W, AMP(1,5))
      CALL FFV2_4P1N_1(W(1,8), W(1,18), GC_37, GC_46, TMP(1))
      call CombineAmp(2,
     & (/5,7/), 
     & (/5,6/),
