...
C     
C     Process: g g > e+ e- WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $    ABS(mdl_MHS*small_width_treatment)), mdl_WHS)
      ...
      CALL IXXXXX(P(0,3),MDL_ME,+1,-1*IC(3),W(1,5))  !  count 2
      CALL IXXXXX(P(0,3),MDL_ME,-1,-1*IC(3),W(1,6))  !  count 2
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,7))  !  count 2
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,8))  !  count 2
      CALL VVS2_3(W(1,1),W(1,3),GC_8,MDL_MH,FK_MDL_WH,W(1,9))  !  count 2
      CALL VVS2_3(W(1,2),W(1,4),GC_8,MDL_MH,FK_MDL_WH,W(1,10))  !  count 2
      CALL FFS1_0(W(1,5),W(1,7),W(1,9),GC_75,AMP(3,1))
      CALL FFS1_0(W(1,5),W(1,7),W(1,10),GC_75,AMP(1,1))
      CALL FFS1_0(W(1,6),W(1,8),W(1,9),GC_75,AMP(4,1))
      CALL FFS1_0(W(1,6),W(1,8),W(1,10),GC_75,AMP(2,1))  !  count 1
