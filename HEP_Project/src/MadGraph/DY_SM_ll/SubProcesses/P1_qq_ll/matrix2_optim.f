...
C     
C     Process: d d~ > e+ e- WEIGHTED<=4 @1
C     Process: d d~ > mu+ mu- WEIGHTED<=4 @1
C     Process: s s~ > e+ e- WEIGHTED<=4 @1
C     Process: s s~ > mu+ mu- WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WZ)
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO,FK_ZERO,W(1,9))  !  count 2
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO,FK_ZERO,W(1,10))  !  count 2
